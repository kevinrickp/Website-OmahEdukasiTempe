    ...
    public function run()
    {
        $produks = [
            [
                ...
                'harga' => 20000,
                'gambar' => 'images/tempezico.jpg', // Pastikan file ini ada di public/image
            ],
            [
                ...
                'harga' => 15000,
                'gambar' => 'images/tempemendoan.jpg', // Ganti dengan path gambar yang sesuai
            ],
            [
                'nama_produk' => 'Keripik Tempe Zico',
                'deskripsi' => 'Cemilan renyah berbasis tempe yang cocok untuk segala usia.',
                'harga' => 10000,
                'gambar' => 'images/keripiktempe.jpg', // Ganti dengan path gambar yang sesuai
            ],
            [
                ...
                'harga' => 25000,
                'gambar' => 'images/penyedaptempe.jpg', // Ganti dengan path gambar yang sesuai
            ],
            [
                ...
                'harga' => 22000,
                'gambar' => 'images/tempebacem.jpg', // Ganti dengan path gambar yang sesuai
            ],
        ];
